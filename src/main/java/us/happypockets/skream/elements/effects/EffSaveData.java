...
@Name("Save Data")
@Description({"Saves the data of a player."})
@Examples({"save player data of \"hotpocket184\" parsed as player"})

public class EffSaveData extends Effect {

    static {
        Skript.registerEffect(EffSaveData.class, "save [player] data (of|for) %players%");
    }
